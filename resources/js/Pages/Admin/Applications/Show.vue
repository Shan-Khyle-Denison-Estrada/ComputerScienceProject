        ...
        <div class="h-full flex flex-col overflow-hidden" :key="application.id">
            ...
            <div class="flex-none mb-3 flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <template v-if="application.status === 'Approved' && application.type === 'Franchise Owner Account' && can('finalize_applications')">
                    ...
                    <template v-else-if="application.status === 'Rejected'">
                        <p class="text-red-600 font-bold italic pr-4">Rejected</p>
                    </template>
                    <template v-else-if="application.status === 'processed'">
                        <p class="text-blue-600 font-bold italic pr-4">Processed</p>
                    </template>
                    <template v-else>
                        ...
                        <div class="flex items-center gap-3">
                            <span class="px-2 py-0.5 text-[10px] font-bold rounded uppercase tracking-wide" 
                                :class="{
                                    ...
                                    'bg-blue-100 text-blue-800': application.status === 'processed',
                                }">
                                {{ application.status }}
                            </span>
