...
const openReportModal = () => {
    pdfLoaded.value = false; // Reset the loader
    
    // Pass current search & filters so the generated report matches the view
...
const closeReportModal = () => {
    ...
    }, 300); // Clear URL after transition
};
            ...
            <Modal :show="showReportModal" @close="closeReportModal" maxWidth="5xl">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-lg font-bold text-gray-900">Assessment Records Report</h2>
                    ...
                    <div class="bg-gray-200 rounded-lg p-2 h-[70vh] w-full shadow-inner border border-gray-300 relative">
                        <div v-if="reportViewerUrl && !pdfLoaded" class="absolute inset-0 z-10 flex flex-col items-center justify-center bg-gray-100 bg-opacity-95 rounded-lg">
                            ...
                            <span class="text-gray-500 text-sm mt-2">This might take a few moments depending on the number of records.</span>
                        </div>
