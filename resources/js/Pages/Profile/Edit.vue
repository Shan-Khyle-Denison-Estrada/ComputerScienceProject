                ...
                <section class="max-w-xl">
                    ...
                    <form @submit.prevent="updateProfile" class="mt-6 space-y-6">
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="shrink-0 relative group cursor-pointer" @click="triggerPhotoUpload">
                                <img v-if="photoPreview" :src="photoPreview" class="h-16 w-16 object-cover rounded-full border border-gray-300" />
                                <div v-else class="h-16 w-16 bg-blue-100 text-blue-600 flex items-center justify-center rounded-full font-bold text-xl border border-blue-200">
                            ...
                            <button type="button" @click="triggerPhotoUpload" class="text-sm font-medium text-blue-600 hover:text-blue-500">Change Photo</button>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="col-span-1">
                                <InputLabel for="first_name" value="First Name" />
                                <TextInput id="first_name" type="text" class="mt-1 block w-full" v-model="form.first_name" required autocomplete="name" />
