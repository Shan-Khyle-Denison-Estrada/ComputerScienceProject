            ...
            <div class="w-1/3 bg-gray-50 border-r border-gray-200 flex flex-col h-full shadow-[inset_1px_0_5px_rgba(0,0,0,0.05)] flex-shrink-0">
                ...
                <div class="p-4 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                    <div v-if="application.status === 'Pending'" class="space-y-2">
                        <PrimaryButton v-if="can('evaluator_approve_applications')"  @click="showApproveModal = true" class="w-full justify-center bg-green-600 hover:bg-green-700">Approve Application</PrimaryButton>
                        <SecondaryButton v-if="can('evaluator_reject_applications')" @click="showRejectModal = true" class="w-full justify-center border-red-500 text-red-700 hover:bg-red-50">Reject Application</SecondaryButton>
                    </div>
