...
<template>
    <Head title="Reviewer Renewal Decision" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Reviewer Final Verification</h2>
        ...
        <div class="w-full flex flex-row gap-0 h-[calc(100vh-100px)] overflow-hidden relative rounded-lg">
            ...
            <div class="w-1/3 bg-gray-50 p-8 flex flex-col h-full flex-shrink-0 border-l border-gray-200">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="font-bold text-xl text-gray-800">Reviewer Verification</h3>
                    <p class="text-sm text-gray-500 mt-2">
                        This application has passed all pre-requisite approvals (Evaluation, Inspection, CAPO) and the assessment has been fully paid. Review the compiled file to proceed.
                    </p>
                </div>

                <div class="pt-4 border-t border-gray-200 space-y-3 flex-shrink-0 mt-auto">
                    <PrimaryButton v-if="can('reviewer_approve_applications')" @click="showApproveModal = true" class="w-full justify-center py-3 bg-green-600 hover:bg-green-700 shadow text-sm">
                        Approve Application
                    </PrimaryButton>
                    <SecondaryButton v-if="can('reviewer_reject_applications')" @click="showRejectModal = true" class="w-full justify-center py-3 !text-red-600 border-red-200 hover:bg-red-50 text-sm">
                        Reject Application
                    </SecondaryButton>
                </div>
            </div>
        ...
        <Modal :show="showApproveModal" @close="showApproveModal = false" maxWidth="sm">
            <div class="p-6 text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">Approve Clearance?</h3>
                <p class="text-sm text-gray-500 mb-6">Are you sure you want to verify and clear this fully paid application?</p>
