            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
                    ...
                    <form v-else @submit.prevent="submitComplaint" class="p-6">
                        ...
                        <div v-if="form.errors.nature_of_complaint" class="mb-5 p-3 bg-red-50 border-l-4 border-red-500 rounded-r-md flex items-start gap-3 shadow-sm">
                            ...
                            <p class="text-sm text-red-700 font-bold leading-tight">
                                {{ form.errors.nature_of_complaint }}
                            </p>
                        </div>
