                        ...
                        <tbody>
                            <tr v-for="app in applications.data" :key="app.id" class="border-b hover:bg-gray-50 transition">
                                ...
                                <td class="p-4 text-sm">
                                    ...
                                    <Link v-else-if="app.application_type === 'New Franchise'" :href="route('inspector.applications.show-new-franchise', app.id)" class="text-blue-600 hover:text-blue-800 font-medium text-sm">Inspect Unit &rarr;</Link>
                                </td>
                            </tr>
                            <tr v-if="applications.data.length === 0">
                                <td colspan="5" class="p-6 text-center text-gray-500">No pending renewals to inspect.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
