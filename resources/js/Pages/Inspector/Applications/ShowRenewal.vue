...
const saveInspectionStatus = (rating) => {
    ...
    router.post(route('inspector.applications.renewal.inspect', application.value.id), {
...
const submitApproval = () => {
    ...
    router.post(route('inspector.applications.renewal.approve', application.value.id), {}, {
        preserveScroll: true,
...
const submitReject = () => {
    ...
    router.post(route('inspector.applications.renewal.reject', application.value.id), { remarks: rejectForm.remarks }, {
        preserveScroll: true,
