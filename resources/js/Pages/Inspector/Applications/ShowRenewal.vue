    ...
    <AuthenticatedLayout>
        ...
        <div class="w-full flex flex-row gap-0 h-[calc(100vh-100px)] overflow-hidden relative rounded-lg">
            ...
            <div class="w-1/3 bg-gray-50 p-6 flex flex-col h-full flex-shrink-0 border-l border-gray-200">
                ...
                <div class="pt-4 border-t border-gray-200 space-y-3 flex-shrink-0">
                    <PrimaryButton v-if="can('inspector_approve_applications')" @click="showApproveModal = true" class="w-full justify-center py-3 bg-green-600 hover:bg-green-700 shadow text-sm">
                        Approve Inspection
                    </PrimaryButton>
                    <SecondaryButton v-if="can('inspector_reject_applications')" @click="showRejectModal = true" class="w-full justify-center py-3 !text-red-600 border-red-200 hover:bg-red-50 text-sm">
        ...
        <Modal :show="showInspectionModal" @close="closeInspectionModal" maxWidth="md">
            <div class="p-6">
                <div class="flex items-center gap-3 border-b pb-4 mb-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-900 leading-tight">Evaluate Inspection Item</h3>
                        <p class="text-sm text-gray-500 mt-0.5">{{ selectedInspectionIndex !== null ? inspectionsList[selectedInspectionIndex].name : '' }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <InputLabel value="Inspection Remarks / Notes" class="text-xs mb-1" />
                    <TextInput v-model="inspectionForm.remarks" class="block w-full text-sm py-2" placeholder="Ex: Missing parts, Needs repair..." />
                </div>
                ...
                <div class="mt-3">
                    <SecondaryButton @click="closeInspectionModal" class="w-full justify-center py-2.5">Cancel</SecondaryButton>
                </div>
            </div>
        </Modal>
        ...
        <Modal :show="showApproveModal" @close="showApproveModal = false" maxWidth="sm">
            <div class="p-6 text-center">
                <h3 class="text-lg font-bold text-gray-900 mb-2">Approve Unit Inspection?</h3>
                <p class="text-sm text-gray-500 mb-6">Are you sure you want to approve this unit inspection?</p>
