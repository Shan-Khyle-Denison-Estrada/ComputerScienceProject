...
const submitApproval = () => {
    ...
    router.post(route('capo.applications.renewal.approve', application.value.id), {}, {
        preserveScroll: true,
...
const submitReject = () => {
    ...
    router.post(route('capo.applications.renewal.reject', application.value.id), { remarks: rejectForm.remarks }, {
        preserveScroll: true,
