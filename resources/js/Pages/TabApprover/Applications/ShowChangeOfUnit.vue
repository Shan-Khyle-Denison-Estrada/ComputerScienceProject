...
<template>
    <Head title="Review Change of Unit - Tabulation" />
    <AuthenticatedLayout>
        <template #header>
            ...
            <div class="w-1/3 bg-gray-50 p-8 flex flex-col h-full flex-shrink-0 border-l border-gray-200">
                <div class="flex flex-col items-center text-center">
                    ...
                    <p class="text-sm text-gray-500 mt-2">
                        Verify the completed application requirements. You may now approve the unit update for final tabulation processing.
                    </p>
                </div>
        ...
        <Modal :show="showApproveModal" @close="showApproveModal = false" maxWidth="sm">
            <div class="p-6 text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">Are you sure you want to officially approve the tabulation for this application?</p>
