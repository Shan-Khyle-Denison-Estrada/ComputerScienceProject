...
const submitApproval = () => {
    ...
    router.post(route('tab_approver.applications.renewal.approve', application.value.id), {}, {
        preserveScroll: true,
...
const submitReject = () => {
    ...
    router.post(route('tab_approver.applications.renewal.reject', application.value.id), { remarks: rejectForm.remarks }, {
        preserveScroll: true,
...
<template>
    <Head title="Tabulation Approval Decision" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tabulation Final Verification</h2>
        ...
        <div class="w-full flex flex-row gap-0 h-[calc(100vh-160px)] overflow-hidden relative">
            ...
            <div class="w-1/3 bg-gray-50 p-8 flex flex-col h-full flex-shrink-0 border-l border-gray-200">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="font-bold text-xl text-gray-800">Tabulation Review</h3>
                    <p class="text-sm text-gray-500 mt-2">
                        This application has been fully processed and approved up to the Sangguniang Panlungsod level. Review the final details to clear it for final release.
                    </p>
                </div>
        ...
        <Modal :show="showApproveModal" @close="showApproveModal = false" maxWidth="sm">
            <div class="p-6 text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">Approve Tabulation?</h3>
                <p class="text-sm text-gray-500 mb-6">Are you sure you want to verify and clear this application for final release?</p>
