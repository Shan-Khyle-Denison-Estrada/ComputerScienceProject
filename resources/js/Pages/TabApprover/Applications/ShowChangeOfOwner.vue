...
<template>
    <Head title="Review Change of Owner - Tabulation" />
    <AuthenticatedLayout>
        <template #header>
        ...
        <div class="w-full flex flex-row gap-0 h-[calc(100vh-100px)] overflow-hidden relative rounded-lg">
            ...
            <div class="w-1/3 bg-gray-50 p-8 flex flex-col h-full flex-shrink-0 border-l border-gray-200">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="font-bold text-xl text-gray-800">Tabulation Final Review</h3>
                    <p class="text-sm text-gray-500 mt-2">
                        Verify the completed application requirements and final payments. You may now approve the ownership change for final processing.
                    </p>
                </div>
        ...
        <Modal :show="showApproveModal" @close="showApproveModal = false" maxWidth="sm">
            <div class="p-6 text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">Are you sure you want to approve this ownership change application for final tabulation?</p>
