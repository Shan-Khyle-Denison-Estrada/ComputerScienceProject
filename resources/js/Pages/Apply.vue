...
<div class="sm:col-span-4 mt-4">
  <InputLabel value="Franchise Certification (Scan/Photo)" class="mb-2 block text-sm font-medium text-gray-700" />
  
  <div class="relative flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 transition-colors hover:bg-gray-50">
    <div class="text-center">
      ...
      <div class="mt-4 flex text-sm leading-6 text-gray-600 justify-center">
        <span class="relative cursor-pointer rounded-md bg-white font-semibold text-blue-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-600 focus-within:ring-offset-2 hover:text-blue-500">
    ...
    <input 
      type="file" 
      @change="(e) => handleCertUpload(e, index)"
