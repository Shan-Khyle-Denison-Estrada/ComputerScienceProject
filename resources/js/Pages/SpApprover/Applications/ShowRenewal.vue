...
<template>
    <Head title="SP Approval Decision" />
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">SP Final Verification</h2>
        ...
        <div class="w-full flex flex-row gap-0 h-[calc(100vh-160px)] overflow-hidden relative">
            ...
            <div class="w-1/3 bg-gray-50 p-8 flex flex-col h-full flex-shrink-0 border-l border-gray-200">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 class="font-bold text-xl text-gray-800">SP Final Review</h3>
                    <p class="text-sm text-gray-500 mt-2">
                        Sangguniang Panlungsod Evaluation: This fully verified file requires the City Council's approval to proceed to tabulation.
                    </p>
                </div>
        ...
        <Modal :show="showApproveModal" @close="showApproveModal = false" maxWidth="sm">
            <div class="p-6 text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">Approve SP Clearance?</h3>
                <p class="text-sm text-gray-500 mb-6">Are you sure you want to verify and clear this application as the Sangguniang Panlungsod Approver?</p>
