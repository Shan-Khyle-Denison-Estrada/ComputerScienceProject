...
class ParticularController extends Controller
{
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'group' => ['nullable', 'string', Rule::in(['renewal', 'change_of_unit', 'change_of_owner', 'change_of_owner_deceased', 'new_franchise', 'new_driver', 'penalty'])],
        ]);
    ...
    public function update(Request $request, Particular $particular)
    {
        ...
        if ($particular->is_system) {
            ...
            $validated = $request->validate([
                ...
                'amount' => 'required|numeric|min:0',
                'description' => 'nullable|string|max:255',
                'group' => ['nullable', 'string', Rule::in(['renewal', 'change_of_unit', 'change_of_owner', 'change_of_owner_deceased', 'new_franchise', 'penalty'])],
            ]);
        }
