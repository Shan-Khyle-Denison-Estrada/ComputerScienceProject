...
return [
    ...
    'evaluator' => [
        ...
        'evaluator_return_applications',      // Using the Return Modal
        'evaluator_reject_applications',      // Using the Reject Modal
        'evaluator_approve_applications',     // Using the Approve/Forward Modal
        'view_assessments',
        'store_assessments',
        'generate_reports',
    ],
    'inspector' => [
        ...
        'inspector_reject_applications',   // Used in Show pages
        'inspector_approve_applications',  // Used in Show pages
    ],
    'city_anti_pollution_officer' => [
        'view_capo_applications',
        'view_application_details',
        'capo_approve_applications',
        'capo_reject_applications', // Also covers returning applications since they use the same route
    ],
    'reviewer' => [
        'view_reviewer_applications',
        'view_application_details',
        'reviewer_approve_applications',
        'reviewer_reject_applications', // Also handles returning apps if they share the reject modal
    ],
    'admin' => [
